        ...
        <>
            ...
            <form onSubmit={handleSubmit}>
                <div className="form-group mb-2">
                    ...
                    <input type="text" name="first_name" className="form-control" onChange={handleForm} placeholder="Jūsų vardas" />
                </div>
                <div className="form-group mb-2">
                    <label className="mb-1">Pavardė:</label>
                    <input type="text" name="last_name" className="form-control" onChange={handleForm} placeholder="Jūsų pavardė" />
                </div>
                <div className="form-group mb-2">
